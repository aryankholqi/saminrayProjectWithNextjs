...
export default function Footer() {
  return (
    <>
      ...
      <div className="container columns-1 lg:columns-3 p-5">
        ...
        <div className="columns-1 sm:columns-3 mb-8 text-center">
          <div className="mb-8">
        ...
        <div className="text-center">
          <h2 className="font-semibold text-xl">
            ما رو توی فضای مجازی دنبال کن
          </h2>
          <p className="mt-5">منتظر پیشنهادای خوبت هستیم :)</p>
          <p className="flex gap-5 mt-6 justify-center">
